...
@section('content')
    ...
    <h2 class="page-title"><i class="fa fa-plus-circle"></i>Tambah Menu Baru</h2>
    ...
    <div class="form-section">
        <form action="{{ url('/penjual/menus') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_makanan" class="form-control" placeholder="Contoh: Nasi Goreng Spesial" value="{{ old('nama_makanan') }}" required>
            </div>

            <div class="form-group">
                <label class="form-label"><i class="fa fa-tag" style="margin-right:8px; color:#28a745"></i>Harga (Rp)</label>
                <input type="number" name="harga" class="form-control" placeholder="Contoh: 25000" value="{{ old('harga') }}" required>
            </div>

            <div class="form-group">
                <label class="form-label"><i class="fa fa-comment" style="margin-right:8px; color:#6f42c1"></i>Deskripsi</label>
                <textarea name="deskripsi" class="form-textarea" placeholder="Jelaskan menu ini dengan singkat dan menarik...">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="file-input-wrapper">
                    <label class="file-input-label" for="foto">
                        <i class="fa fa-cloud-upload-alt"></i> Klik untuk upload foto
                    </label>
            ...
            <div class="form-group">
                <div class="checkbox-wrapper">
                    <input type="checkbox" id="tersedia" name="tersedia" value="1" checked>
                    <label for="tersedia"><i class="fa fa-check-circle" style="color:#28a745"></i> Menu ini tersedia</label>
                </div>
            </div>

            <div class="btn-group">
                <button type="submit" class="btn-submit"><i class="fa fa-save"></i> Simpan Menu</button>
